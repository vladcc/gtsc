...
static bool test_cstr_erase(void)
{
    {
        cstr str_, * str = &str_;
        check(str == cstr_create_str(str, "The quick brown fox jumps over",
            25));
    ...
    { //bugfix
        cstr str_, * str = &str_;
        check(str == cstr_create_str(str, "The quick brown fox jumps", 25));
        check(cstr_cap(str) == 25);
        check(cstr_len(str) == 25);
        check(strcmp(cstr_data(str), "The quick brown fox jumps") == 0);

        check(str == cstr_erase(str, 19, 6));
        check(cstr_cap(str) == 25);
        check(cstr_len(str) == 19);
        check(strcmp(cstr_data(str), "The quick brown fox") == 0);
